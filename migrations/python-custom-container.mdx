...
<Note>
**Local vs Deployed Ports**: For local testing, you can use any port (like 8081 above). However, when deployed to Smithery, your server **must** listen on the `PORT` environment variable, which Smithery will set to 8080.
</Note>
