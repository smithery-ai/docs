...
1. Browse servers at [smithery.ai](https://smithery.ai) or query our [Registry API](/concepts/registry_search_servers)
...
- Learn about [Configuration Profiles](/concepts/profiles) for managing multiple servers
- Explore the [Registry API](/concepts/registry_search_servers) for programmatic server discovery
