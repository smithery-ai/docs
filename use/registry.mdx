---
title: "Registry API"
description: "Programmatically search for MCP servers."
---

The Smithery Registry API provides a programmatic way to search for MCP servers hosted and listed in our registry. This documentation will walk you through using the Registry API to obtain metadata about an MCP server.

## Authentication

All registry API endpoints require authentication via a bearer token. You can create an API key [here](https://smithery.ai/account/api-keys).
