...
- Prefer automatic builds without Docker complexity
- Have a standard TypeScript project structure with npm/package.json
- Don't need custom system dependencies or complex runtime environments
...
That's it! This minimal configuration is intentional - Smithery CLI handles containerization, HTTP transport, and deployment automatically for TypeScript projects.
