...
- **[TypeScript with Smithery CLI](/build/deployments/typescript)** (Recommended) - For servers using the official MCP TypeScript SDK.
- **[Python with Smithery CLI](/build/deployments/python)** (Recommended) - For servers using FastMCP and Python.
- **[Custom Docker Container](/build/deployments/custom-container)** (Advanced) - Need custom environment or using another language? Get full Docker control
