...
description: 'Build and deploy a Python MCP server in under 5 minutes using FastMCP and Smithery'
---

# FastMCP Quick Start

Build and deploy a Python MCP server in under 5 minutes using FastMCP's simplified API and Smithery's one-click deployment.

## Why FastMCP?

FastMCP dramatically reduces boilerplate compared to the standard Python SDK:
...
<Card title="Minimal Boilerplate" icon="code">
  FastMCP reduces setup code by ~80%
</Card>
...
<Card title="Easy Deployment" icon="cloud">
  One-click Smithery deployment with no Docker knowledge required
</Card>
...
<Note>
  ...
  **Lines of Code**: ~200 (vs ~400+ with standard SDK)  
  **Production Ready**: ✅
</Note>