...
- For configuration support, implement a schema via `/.well-known/mcp-config` endpoint (see [Session Configuration](/build/session-config#well-known-endpoint-approach))
