...
Session configurations let you give your users flexibility in how your MCP server behaves for their specific connection. Think of it like your coffee order - each time you visit, you can choose something completely different. You're never stuck with the same drink.

Similarly, configurations allow each of your users to customize their session differently, and provide a secure way for them to pass secrets (e.g., API keys) to your server.
