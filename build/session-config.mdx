...
Users who connect to your server on Smithery may prefer to use [Configuration Profiles](/use/profiles). When a profile is used, Smithery's gateway injects the correct query parameters when connecting to your MCP server.
