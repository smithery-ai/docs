...
Define a simple MCP tool without configuration complexity:
...
## Step 3: Create Configuration Middleware

Now let's add support for Smithery configuration. First, create the middleware that will extract config from URL parameters:
...
## Step 4: Add Configuration Handling
...
## Step 5: Enhance Tool with Configuration
...
## Step 6: Complete Server Startup
